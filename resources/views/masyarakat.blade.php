    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-white dark:bg-red-800 overflow-hidden shadow-sm sm:rounded-lg">
                <h2 class="text-lg font-semibold mt-4 pb-7 text-center mb-7">Data Masyarakat</h2>
                    ...
                    <table style="width: 100%; border-collapse: collapse;">
                        <thead style="background-color: #5FBDFF;">
                            <tr>
                                ...
                                <th style="padding: 8px; text-align: center;">Telpon</th>
                        ...
                        <tbody style="background-color: #7B66FF;">
                            @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td style="padding: 8px; text-align: center;">{{ $item->nama }}</td>
                                        <td style="padding: 8px; text-align: center;">{{ $item->email }}</td>
                                        <td style="padding: 8px; text-align: center;">{{ $item->no_telp }}</td>
                                        <!-- Tambahkan kolom lainnya sesuai kebutuhan -->
                                    </tr>
                            @endforeach
                        </tbody>
